...
import TotalTokenDivs from '../components/TotalTokenDivs';
                ...
                <div className='fixed w-4/5 h-4/5 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col justify-between'>
                    <div className="sm:hidden flex justify-between items-center">
                        <div className='z-10 flex flex-col-reverse justify-center items-center'>
                            <h2 className='font-pressStart text-center mt-8'>The entire collection of Bobos... Get yours now!!!</h2>
                    ...
                    <div className='sm:flex sm:flex-row'>
                        ...
                        <p className='z-5 md:hidden lg:hidden xl:hidden 2xl:hidden 3xl:hidden font-pressStart text-center text-xs animate-pulse'>The entire collection of Bobos... Get yours now!!!</p>
