                    ...
                    <div className='z-0 grid-container absolute inset-x-0 bottom-10 py-10 h-4/5 grid grid-cols-4 sm:grid-cols-2 md:grid-cols-3 gap-4 overflow-y-auto'>
                        <div className='col-span-4 font-pressStart text-center'>
                            ...
                            <SkipButton />
                                ...
                                <Image className='mx-auto' src={lore2}></Image>                                {"The legend of Bobo began when he was discovered by a group of NFT degens, who were relentlessly hunting for the next big project. Drawn in by his peculiar appearance and a mysterious aura that seemed to surround him, they decided to mint the first-ever Bobo NFT. Little did they know, this simple action would unlock Bobo's hidden potential and forever change the course of the metaverse."}
